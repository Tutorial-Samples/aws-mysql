...
FROM maven:3.6.3-jdk-11 as aws-sql
WORKDIR /aws-sql
...
ARG DEPENDENCY=/aws-sql/target/dependency
COPY --from=aws-sql ${DEPENDENCY}/BOOT-INF/lib /app/lib
COPY --from=aws-sql ${DEPENDENCY}/META-INF /app/META-INF
COPY --from=aws-sql ${DEPENDENCY}/BOOT-INF/classes /app
##ENTRYPOINT ["sh", "-c", "java -jar /app.jar"]
ENTRYPOINT ["java","-cp","app:app/lib/*","com.aws.mysql.AwsMysqlApplication"]